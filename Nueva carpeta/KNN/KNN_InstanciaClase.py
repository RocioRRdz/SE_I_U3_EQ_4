...
# Ejemplo:      PASAR AL FORMATO SIGUIENTE
# [ [ [ '80', '90' ,..., '90' ], 'Guerrero'],
#   [ [ '75', '59' ,..., '90' ], 'Duelista']
# ]
...
for NoCaso, registro in enumerate(instancia):  #por cada elemento/registro de la instancia       #num indices o iteracciones de una instancia: enumerate
